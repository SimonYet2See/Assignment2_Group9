...
CREATE TABLE `usertransactions` (
  ...
  `category` enum('Job','Stock','Fund','Interest','Gift','Rental','Bonus','Other','Transport','Food','Clothes','Entertainment','Medical','Education','Rent','Subscription','Utilities') NOT NULL,
...
-- Dump completed on 2025-07-27 16:32:52
